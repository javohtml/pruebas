...
<html>
  ...
  <body class="skin-blue sidebar-mini">
                  ...
                  <div class="table-responsive">
                    <?php
                        if($row=='none'){
                          ...
                          echo '<table id="example2" class="table table-bordered table-hover"><thead><tr><th style="text-align: center;">Codigo</th><th style="text-align: center; width:40%;">Nombre</th><th style="text-align: center;">Cierra en</th><th style="text-align: center;">Estado</th><th style="text-align: center;">Detalle</th><th style="text-align: center;">Borrar</th></tr></thead><tbody id="results" style="text-align:center;">';
                          $estado = "";
                          $contando = 0;
                          for($o=0; $o<count($row); $o++){
                            ...
                            if($row[$o][3]!==5){
                              ...
                              $your_date = strtotime($fechaC);
                              $datediff = $now - $your_date;
                              $dates = floor($datediff/(60*60*24));
                              if($dates<=0){
                                if(abs($dates)<=3)
                                  echo '<td style="color:red;"><b>'.abs($dates).'</b></td>';
                                elseif(abs($dates)<=6)
                                  echo '<td style="color:#C7AE25;"><b>'.abs($dates).'</b></td>';
                                elseif(abs($dates)>=7)
                                  echo '<td style="color:green"><b>'.abs($dates).'</b></td>';
                              }else{
                                echo '<td>Cerrada</td>';
                              }
                            }
    ...
    <script src="../js/idDetailFav.js"></script>
    <script type='text/javascript'>
    function salir(){
