...
<html>
  ...
  <body class="skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview"><a href="avanzada.php"><i class="fa fa-search"></i><span>Busqueda Avanzada</span></a></li>
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Busqueda de licitaciones avanzadas
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <form role="form" id="forma">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Encuentra Licitaciones..." name="buscar" id="buscar" required="require">
                                            <p class="help-block"></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Estado</label>
                                            <select class="form-control" name="estado" id="estado" required="require">
                                        ...
                                        <button type="submit" class="btn btn-default">Buscar Licitación</button>
                                    </form>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
                              ...
                              <div class="col-lg-12">
                                <div class="table-responsive">
                                  <table class="table table-striped table-bordered table-hover">
                                    <thead><tr><th>Codigo</th><th>Nombre</th><th>Fecha</th><th>Operación</th></tr></thead>
    ...
    <script src="js/avanzada.js" type="text/javascript"></script>
  </body>
</html>
