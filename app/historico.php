...
<html>
  ...
  <body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Hostial de licitaciones
            <small>Comparando...</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-star"></i> Favoritos</a></li>
            <li class="active">Comparando</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title" id="buscando"></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="table-responsive">
                      <?php
                         ...
                         if($row=='none'){
                          echo '<div class="alert alert-danger">No hemos encontrado licitaciones parecidas</div>';
                        }else{
                          echo '<table id="example2" class="table table-bordered table-hover"><thead><tr><th style="text-align: center;">Codigo</th><th style="text-align: center; width:40%;">Nombre</th><th style="text-align: center;">Cierra el</th><th style="text-align: center;">Detalle</th><th style="text-align: center;">Borrar</th></tr></thead><tbody id="results" style="text-align:center;">';
                          ...
                          for($o=0; $o<count($row); $o++){
                            ...
                            echo '<input type="hidden" name="hdnOperation" value="hdnDelFav">';
                            echo '<input type="hidden" name="code" value="'.$row[$o][0].'">';
                            echo '<button type="submit" class="btn btn-danger btn-circle"><i class="fa fa-ban"></i></button></form></td></tr>';
                            $contando++;
                          }
                          if($contando==0)
    ...
    if (typeof(Storage) !== "undefined") {
        // Retrieve
        var match = window.localStorage.getItem("match");
        var code  = window.localStorage.getItem("code");
        document.getElementById("buscando").innerHTML = "<a data-toggle=\"modal\" data-target=\"#myModal\" onclick=\"modaldata('" + code + "')\"><i class=\"fa fa-search\"></i> Buscando Licitacion parecida a : " + match + "</a>";
    } else {
        document.getElementById("buscando").innerHTML = "Sorry, your browser does not support Web Storage...";
    }
  </script>
    <script type="text/javascript">
