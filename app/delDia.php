...
<html>
  ...
  <body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Todas las Licitaciones del Día
            <small>Principal</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-search"></i> Home</a></li>
            <li class="active">Todas las del día</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Licitaciones Del día</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                          <thead>
                              <tr>
                                  ...
                                  <th style="text-align: center;">Cierra el</th>
                              </tr>
                          </thead>
                          <tbody id="results">
    ...
    <script src="../js/frontlic.js"></script>
    <script type='text/javascript'>
    function salir(){
