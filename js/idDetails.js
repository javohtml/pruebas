...
function modaldata(codLic){
	...
	var encontradas = 0;
	var countGround = 0;
	getJSON('http://api.mercadopublico.cl/servicios/v1/publico/licitaciones.json?codigo=' + codLic +'&ticket=0C0C340A-7E53-4471-A97D-D7A91BB98FBC').then(function(data) {
